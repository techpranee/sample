...
const { cleanerappPassportStrategy } = require('./config/cleanerappPassportStrategy');
const { dashboardPassportStrategy } = require('./config/dashboardPassportStrategy');
...
cleanerappPassportStrategy(passport);
dashboardPassportStrategy(passport);
