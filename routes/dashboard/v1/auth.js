...
const authController =  require('../../../controller/dashboard/v1/authController');
...
router.route('/logout').post(auth(PLATFORM.DASHBOARD), authController.logout);
...
router.get('/login/google',(req,res)=>{
  req.session.platform = 'dashboard';
