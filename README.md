...
3. Credentials
	...
	**password** : 8fw_WjOL8D29Oez
	...
	- One user with Cleaner role,
	# Default Cleaner credentials
	**username** : Sarai.Flatley@yahoo.com
	**password** : nLXBA_dmlQnaV6_

	- One user with Hub role,
	# Default Hub credentials
	**username** : Angelina.Lindgren@hotmail.com
