...
where.isDeleted = false;            let user = await dbService.findOne(User,where);
            ...
            let result = await authService.loginWithOTP(params.username,null,authConstant.PLATFORM.CLEANERAPP,roleAccess);
            if(result.flag){
...
module.exports = {
    register,sendOtpForLogin,loginWithOTP,logout,addPlayerId,removePlayerId
}